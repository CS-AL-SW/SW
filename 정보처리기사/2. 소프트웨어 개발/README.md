...
- 소프으퉤어 개발에 있어 기능을 나누고 추상화하여 소프트웨어의 성능을 향상시키고 유지보수를 효과적으로 구현하기 위한 기법을 의미한다.
- 종류
...
| 안전<br>(security)    | 소프트웨워가 불법적인 침입으로부터 시스템을 보호할 수 있는지 확인한다.                  |
